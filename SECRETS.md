...
`AGENT_MODEL` (default `gpt-4.1`), `AGENT_BACKUP_MODEL` (default `gpt-4o`), `AGENT_HEDGE_MS` (default `900`), `AGENT_SPECULATE` (`true` to start the agent on partial transcripts),
